...
(function() {
    ...
    const totalDeliveryContainer = document.querySelector("#delivery-price");
    ...
    function displayCartTotal() {
      ...
      displayDeliveryCosts(total);
    }
    
    function displayDeliveryCosts(total) {
        if (total < 300) {
            totalDeliveryContainer.innerHTML = '<span class="delivery-costs-value">Delivery Costs Added to Total: $10</span>';
        }
        else {
            totalDeliveryContainer.innerHTML = '<span class="delivery-costs-value">Delivery Costs Added to Total: $0</span>';
        }
    }
    ...
    function displayProducts() {
      ...
      var isInvoicePage = window.location.pathname.endsWith('invoice.php');
    ...
    function saveProduct(clickedBtn) {
      ...
      const prodQuantity = clickedBtn.parentElement.childNodes.item(7).value;
    ...
    function clearCart(showProducts = true) {
    ...
    document.addEventListener("DOMContentLoaded", function(e) {
      ...
      if (window.location.pathname.endsWith('invoice.php')) {
        // Clear the cart after showing the invoice.
        clearCart(false); // Don't display products.
      }
    });
